...
/**
  *
  */
export function longFindColLength(str: string, key: number[]) {
    var retValue = generateUniformArray(0, key.length);
    var o = 0;
    for (var i = 0; i < str.length; o++) {
        if (o % 2 == 1) {
            i++;
    ...
    return undoPermutation(retValue, key);
}
